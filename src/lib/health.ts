...
import { CheckIn, DeckResponse, Letter, Memory, Ping } from '../types/models';
...
export function computeHealth(input: Input): Health {
  const { checkins, memories, letters, pings, deck, meId, partnerId } = input;
  ...
  // Shared activity in the last 7 days.
